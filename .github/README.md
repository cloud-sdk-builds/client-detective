...
[`@aws-sdk/client-detective`](https://www.npmjs.com/package/@aws-sdk/client-detective/v/3.22.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-detective@3.22.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G0CD+qpcYqi5s3pvfTdqpHYyS2nyRJairMABJKLza9IJ7H5q5Ld0CLGvxv/ooRy+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-detective": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-detective@3.22.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-detective@3.22.0/index.min.mjs": "sha384-G0CD+qpcYqi5s3pvfTdqpHYyS2nyRJairMABJKLza9IJ7H5q5Ld0CLGvxv/ooRy+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-detective/blob/refs/tags/3.22.0/LICENSE
```
